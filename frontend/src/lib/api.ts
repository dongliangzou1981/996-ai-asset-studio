...
export type MainTaskPanelCandidate = {
  ...
  is_png?: boolean;
  alpha_channel_present?: boolean;
  alpha_min?: number | null;
  alpha_max?: number | null;
  alpha_all_255?: boolean;
  has_real_transparency?: boolean;
  suspected_baked_background?: boolean;
  transparency_postprocess_applied?: boolean;
  transparency_postprocess_status?: string;
